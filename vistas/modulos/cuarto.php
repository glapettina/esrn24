                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                              ...
                              if ($value["estado"] != 0) {
                                ...
                                echo '<td><button class="btn btn-success btn-xs btnActivar" tabla="cuarto" idAlumno="'.$value["id"].'" estadoAlumno="0">Activado</button></td>';

                            }else{

                                echo '<td><button class="btn btn-danger btn-xs btnActivar" tabla="cuarto" idAlumno="'.$value["id"].'" estadoAlumno="1">Desactivado</button></td>';
                            }
