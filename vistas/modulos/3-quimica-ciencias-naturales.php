        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso=7 idCurso2=8 idCurso=20 tabla="tercero" data-toggle="modal" data-target="#modalCopiaSaberes">
                  
                  Copia Saberes
                </button>

                <button class="btn btn-primary btnInformeArea" area="quimica" periodo="'.$_SESSION['periodo'].'" idCurso=7 idCurso2=8 idCurso3=20 tabla="tercero" modalidad="Ciencias Naturales" informe="informe-area-orientacion">
          ...
          <div class="modal-body">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <label for="saberesApreciacion">Saberes</label>
        ...
        <!-- ENTRADA PARA LA APRECIACION --> 
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control input-lg" type="text" name="asistenciaQuimica" id="asistenciaQuimica" placeholder="Ingresar asistencia (%)" required>
         ...
         <?php
              ...
              $tabla = "tercero";
              $curso = "3-quimica-ciencias-naturales";
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
         ...
         <?php
              ...
              $copiaSaberes -> ctrCopiarSaberesQuimica($tabla, $curso, $ncurso1, $ncurso2, $ncurso3, $periodo);
